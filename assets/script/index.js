...
function displayPost() {
    ...
    postElement.innerHTML = "\n   <h1 class=\"post-title\">".concat(posts[postId].title, "</h1><button id=").concat(uniqueIdentity, " class=\"close\">X</button>\n    <p class=\"post-body\">").concat((posts[postId].body.replace(/\n/g, '<br>')), "</p>");
    (_a = document.querySelector("#postArea")) === null || _a === void 0 ? void 0 : _a.appendChild(postElement);
    (_b = document.getElementById(uniqueIdentity)) === null || _b === void 0 ? void 0 : _b.addEventListener('click', function () { return SurePage(postElement, uniqueIdentity); });
}
function SurePage(postElement, uniqueIdentity) {
    var modal = document.getElementById("myModal");
    // Get the button that opens the modal
    var btn = document.getElementById(uniqueIdentity);
    // Get the <span> element that closes the modal
    var span = document.getElementsByClassName("closeBtn")[0];
    var clsBtn = document.getElementById("yesButton");
    console.log(clsBtn);
    console.log(postElement);
    if (clsBtn)
        clsBtn.addEventListener('click', function () { return deletePost(postElement); });
